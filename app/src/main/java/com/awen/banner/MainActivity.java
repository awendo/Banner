...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        // 先拿到图片id
        int[] ivIDs = new int[] { R.drawable.a, R.drawable.a, R.drawable.a,
        ...
        for (int id : ivIDs) {
            ...
            // 设置小点的宽和高
            LinearLayoutCompat.LayoutParams params = new LinearLayoutCompat.LayoutParams(8, 8);
            // 设置小点的左边距
